...
See [AppStore/PRIVACY_POLICY.md](https://github.com/RW2523/EchoMind/blob/main/AppStore/PRIVACY_POLICY.md).
...
packages. Details in [docs/ARCHITECTURE.md](Architecture).
...
**261 tests** cover the pure logic exhaustively — clustering (order-invariant), chunking,
...
| App Store submission | ⏳ Build-ready; needs paid Developer Program — see [AppStore/TESTFLIGHT.md](https://github.com/RW2523/EchoMind/blob/main/AppStore/TESTFLIGHT.md) |
...
- **[User Manual](User-Guide)** — how to use every feature
...
- Shipping: [PRODUCTION_PLAN.md](PRODUCTION_PLAN.md), [AppStore/](https://github.com/RW2523/EchoMind/blob/main/AppStore/)
