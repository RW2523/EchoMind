...
a physical-device validation pass. See [../AppStore/TESTFLIGHT.md](../AppStore/TESTFLIGHT.md).

**How do I contribute / build it?**
See the [README](../README.md) and [Architecture](ARCHITECTURE.md). Build with Xcode 26+,
